...
+(NSString *)longlongToDate:(NSString *)sender
{
    ...
    return [date toStringWithDateFormat:[NSDate dateFormatString]];
}
...
+(NSString *)longlongToDateTime:(NSString *)sender
{
    ...
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:[sender longLongValue]];
    return [date toStringWithDateFormat:[NSDate timestampFormatString]];
}
...
+(NSString *)longlongToDayDateTime:(NSString *)sender
{
    ...
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:[sender longLongValue]];
    return [date toStringWithDateFormat:[NSDate DayFormatString]];
